...
struct AccountView: View {
    ...
    private var myLowesRewardsSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            // Tier Progress
            HStack(spacing: 4) {
                tierBar(label: "Bronze Key", color: Color(red: 0.7, green: 0.45, blue: 0.25), progress: 1.0)
                tierBar(label: "Silver Key", color: .gray, progress: 1.0)
                tierBar(label: "Gold Key", color: Color(red: 0.7, green: 0.6, blue: 0.3), progress: 1.0)
            }
            .padding(.horizontal, 16)
    ...
    private func tierBar(label: String, color: Color, progress: CGFloat) -> some View {
        VStack(alignment: .leading, spacing: 4) {
            Text(label)
                .font(.caption2)
                .foregroundStyle(.secondary)
